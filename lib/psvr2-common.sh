...
PSVR2_USB_RECOVERY_COOLDOWN_SECONDS="${PSVR2_USB_RECOVERY_COOLDOWN_SECONDS:-8}"
...
for setting in PSVR2_RENDER_SCALE PSVR2_REFRESH_RATE PSVR2_LINK_STABILITY_CHECKS \
    ...
    PSVR2_USB_RECOVERY_COOLDOWN_SECONDS; do
...
export PSVR2_USB_RECOVERY_COOLDOWN_SECONDS
