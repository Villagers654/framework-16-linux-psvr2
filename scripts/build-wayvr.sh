...
if git -C "$source_dir" apply --check "$repo/patches/wayvr-psvr2-dashboard.patch"; then
  git -C "$source_dir" apply "$repo/patches/wayvr-psvr2-dashboard.patch"
elif git -C "$source_dir" apply --reverse --check "$repo/patches/wayvr-psvr2-dashboard.patch"; then
